...
public class TalkerMapSave extends AbstractNodeMain {
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("/navi_manager/save_map", std_msgs.String._TYPE);
