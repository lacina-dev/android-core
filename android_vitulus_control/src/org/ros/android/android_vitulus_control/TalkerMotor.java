 ...
 */
public class TalkerMotor extends AbstractNodeMain {
    Publisher<std_msgs.Bool> publisher;

    @Override
    public GraphName getDefaultNodeName() {
        return GraphName.of("android/motors");
    }
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("motor_power", std_msgs.Bool._TYPE);
