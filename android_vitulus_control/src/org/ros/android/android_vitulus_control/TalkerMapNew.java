 ...
 */
public class TalkerMapNew extends AbstractNodeMain {
    Publisher<std_msgs.String> publisher;

    @Override
    public GraphName getDefaultNodeName() {
        return GraphName.of("android/mapnew");
    }
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("/navi_manager/new_map", std_msgs.String._TYPE);
