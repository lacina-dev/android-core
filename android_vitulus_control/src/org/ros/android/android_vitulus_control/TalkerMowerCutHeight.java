 ...
 */
public class TalkerMowerCutHeight extends AbstractNodeMain {
    Publisher<std_msgs.Int32> publisher;

    @Override
    public GraphName getDefaultNodeName() {
        return GraphName.of("android/mover_cut_height");
    }
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("mower_set_height", std_msgs.Int32._TYPE);
