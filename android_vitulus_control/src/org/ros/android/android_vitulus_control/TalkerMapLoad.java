 ...
 */
public class TalkerMapLoad extends AbstractNodeMain {
    Publisher<std_msgs.String> publisher;

    @Override
    public GraphName getDefaultNodeName() {
        return GraphName.of("android/mapload");
    }
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("/navi_manager/load_map", std_msgs.String._TYPE);
