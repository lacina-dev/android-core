 ...
 */
public class TalkerSetSpeed extends AbstractNodeMain {
    Publisher<std_msgs.String> publisher;

    @Override
    public GraphName getDefaultNodeName() {
        return GraphName.of("android/setspeed");
    }
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher("/navi_manager/speed", std_msgs.String._TYPE);
