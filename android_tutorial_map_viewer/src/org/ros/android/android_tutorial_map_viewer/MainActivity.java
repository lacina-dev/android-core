...
public class MainActivity extends RosActivity {
  ...
  private static final String ROBOT_FRAME = "t265_pose_frame";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    visualizationView.onCreate(Lists.<Layer>newArrayList(cameraControlLayer,
            new OccupancyGridLayer("/rtabmap/grid_map"), new LaserScanLayer("/scan"), new RobotLayer(ROBOT_FRAME)));
//            new LaserScanLayer("/scan"), new RobotLayer(ROBOT_FRAME), new OccupancyGridLayer("/rtabmap/grid_map")));
